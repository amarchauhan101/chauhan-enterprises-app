...
function BottomCategoryHeader({
  ...
  // const name = categories.map((item)=>item.name);
  console.log(category, setCategory);
  useEffect(() => {
    const subCategory =
      categories && categories.find((item) => item.name == category);
...
export default BottomCategoryHeader;
