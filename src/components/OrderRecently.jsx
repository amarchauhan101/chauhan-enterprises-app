...
function OrderRecently({ order, products }) {
    ...
    <div className="bg-card rounded-xl shadow-lg border border-border overflow-hidden">
      ...
      <div className="bg-muted/50 p-6 border-b border-border">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-2xl lg:text-3xl text-card-foreground font-bold ">
              Recently Order Product
            </h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <select
              ...
              className="px-3 py-2 text-foreground bg-background border border-border rounded-lg text-sm focus:ring-2 focus:ring-ring focus:border-transparent"
            >
            ...
            {currentItems.map((product) => (
              <div key={product._id} className="bg-card border border-border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                <div className="p-4">
                  ...
                  {/* Items */}
                  <div className="mb-4">
                    <div className="text-sm font-medium text-muted-foreground mb-2">Items ({product.items.length})</div>
