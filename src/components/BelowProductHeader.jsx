...
function BelowProductHeader({
  ...
  console.log("product in header=>", products.products);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="block lg:hidden space-y-4">
          ...
          <div className="flex gap-3">
            <Button 
              className="flex-1 h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-medium transition-all duration-200 shadow-md hover:shadow-lg" 
              onClick={() => {setFilter({
                search,
                category,
                priceFilter
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <select 
            value={priceFilter}
            onChange={(e) => setPriceFilter(e.target.value)} 
            className="h-12 px-4 bg-background text-foreground border border-border rounded-lg focus:border-ring focus:ring-ring min-w-44"
          >
            <option value="All">Price: All</option>
            <option value="low to high">Price: Low to High</option>
            <option value="high to low">Price: High to Low</option>
          ...
          <div className="flex gap-3">
            <Button 
              className="h-12 px-6 bg-primary hover:bg-primary/90 text-primary-foreground font-medium transition-all duration-200 shadow-md hover:shadow-lg" 
              onClick={() => {setFilter({
                search,
                category,
                priceFilter
...
export default BelowProductHeader;
